...
var UnorderedList = function UnorderedList(_ref) {
  ...
  var classNames = (0, _classnames2.default)("".concat(prefix, "--list--unordered"), className, (_classnames = {}, _defineProperty(_classnames, "".concat(prefix, "--list--nested"), nested), _defineProperty(_classnames, "".concat(prefix, "--list--expressive"), isExpressive), _classnames));
