...
var Dropdown = /*#__PURE__*/_react.default.forwardRef(function Dropdown(_ref, ref) {
  ...
  var titleClasses = (0, _classnames.default)("".concat(prefix, "--label"), (_cx2 = {}, _defineProperty(_cx2, "".concat(prefix, "--label--disabled"), disabled), _defineProperty(_cx2, "".concat(prefix, "--visually-hidden"), hideLabel), _cx2));
