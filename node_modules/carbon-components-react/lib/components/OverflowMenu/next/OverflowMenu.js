...
var _excluded = ["children", "renderIcon"];
...
function OverflowMenu(_ref) {
  ...
  var triggerClasses = (0, _classnames.default)("".concat(prefix, "--overflow-menu"), _defineProperty({}, "".concat(prefix, "--overflow-menu--open"), open));
