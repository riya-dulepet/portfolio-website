...
var Modal = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Modal, [{
    ...
    value: function render() {
      ...
      var footerClasses = (0, _classnames.default)("".concat(prefix, "--modal-footer"), _defineProperty({}, "".concat(prefix, "--modal-footer--three-button"), Array.isArray(secondaryButtons) && secondaryButtons.length === 2));
      ...
      }, /*#__PURE__*/_react.default.createElement(SecondaryButtonSet, null), /*#__PURE__*/_react.default.createElement(_Button.default, {
...
_defineProperty(Modal, "propTypes", (_defineProperty2 = {
  ...
  return null;
}), _defineProperty(_defineProperty2, "selectorPrimaryFocus", _propTypes.default.string), _defineProperty(_defineProperty2, "selectorsFloatingMenus", _propTypes.default.arrayOf(_propTypes.default.string)), _defineProperty(_defineProperty2, "shouldSubmitOnEnter", _propTypes.default.bool), _defineProperty(_defineProperty2, "size", _propTypes.default.oneOf(['xs', 'sm', 'md', 'lg'])), _defineProperty2));
