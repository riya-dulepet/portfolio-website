...
var FormGroup = function FormGroup(_ref) {
  ...
  var classNamesLegend = (0, _classnames2.default)("".concat(prefix, "--label"), className);
  var classNamesFieldset = (0, _classnames2.default)("".concat(prefix, "--fieldset"), className, _defineProperty({}, "".concat(prefix, "--fieldset--no-margin"), !hasMargin));
