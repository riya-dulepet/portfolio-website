...
var _excluded = ["aria-labelledby", "aria-label", "className", "containerClassName", "children", "danger", "preventCloseOnClickOutside", "selectorPrimaryFocus", "size"],
...
var ComposedModal = /*#__PURE__*/function (_Component) {
  ...
  _createClass(ComposedModal, [{
    ...
    value: function render() {
      ...
      var containerClass = (0, _classnames.default)((_classNames2 = {}, _defineProperty(_classNames2, "".concat(prefix, "--modal-container"), true), _defineProperty(_classNames2, "".concat(prefix, "--modal-container--").concat(size), size), _defineProperty(_classNames2, containerClassName, containerClassName), _classNames2)); // Generate aria-label based on Modal Header label if one is not provided (L253)
...
_defineProperty(ComposedModal, "propTypes", (_defineProperty2 = {}, _defineProperty(_defineProperty2, 'aria-label', _propTypes.default.string), _defineProperty(_defineProperty2, 'aria-labelledby', _propTypes.default.string), _defineProperty(_defineProperty2, "children", _propTypes.default.node), _defineProperty(_defineProperty2, "className", _propTypes.default.string), _defineProperty(_defineProperty2, "containerClassName", _propTypes.default.string), _defineProperty(_defineProperty2, "danger", _propTypes.default.bool), _defineProperty(_defineProperty2, "onClose", _propTypes.default.func), _defineProperty(_defineProperty2, "onKeyDown", _propTypes.default.func), _defineProperty(_defineProperty2, "open", _propTypes.default.bool), _defineProperty(_defineProperty2, "preventCloseOnClickOutside", _propTypes.default.bool), _defineProperty(_defineProperty2, "selectorPrimaryFocus", _propTypes.default.string), _defineProperty(_defineProperty2, "selectorsFloatingMenus", _propTypes.default.string), _defineProperty(_defineProperty2, "size", _propTypes.default.oneOf(['xs', 'sm', 'md', 'lg'])), _defineProperty2));
...
function ModalBody(props) {
  ...
  var contentClass = (0, _classnames.default)((_classNames8 = {}, _defineProperty(_classNames8, "".concat(prefix, "--modal-content"), true), _defineProperty(_classNames8, "".concat(prefix, "--modal-content--with-form"), hasForm), _defineProperty(_classNames8, "".concat(prefix, "--modal-scroll-content"), hasScrollingContent), _defineProperty(_classNames8, className, className), _classNames8));
...
var ModalFooter = /*#__PURE__*/function (_Component3) {
  ...
  _createClass(ModalFooter, [{
    ...
    value: function render() {
      ...
      var footerClass = (0, _classnames.default)((_classNames9 = {}, _defineProperty(_classNames9, "".concat(prefix, "--modal-footer"), true), _defineProperty(_classNames9, className, className), _defineProperty(_classNames9, "".concat(prefix, "--modal-footer--three-button"), Array.isArray(secondaryButtons) && secondaryButtons.length === 2), _classNames9));
