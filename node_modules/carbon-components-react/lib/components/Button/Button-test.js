...
describe('ButtonSkeleton', function () {
  describe('Renders as expected', function () {
    ...
    var wrapperMd = (0, _enzyme.shallow)( /*#__PURE__*/_react.default.createElement(_Button2.default, {
      size: "md"
    }));
    it('renders the medium size', function () {
      expect(wrapperMd.hasClass("".concat(prefix, "--btn--md"))).toEqual(true);
    });
    var wrapperLg = (0, _enzyme.shallow)( /*#__PURE__*/_react.default.createElement(_Button2.default, {
      size: "lg"
    }));
    it('renders the large size', function () {
      expect(wrapperLg.hasClass("".concat(prefix, "--btn--lg"))).toEqual(true);
    });
    var wrapperXl = (0, _enzyme.shallow)( /*#__PURE__*/_react.default.createElement(_Button2.default, {
      size: "xl"
    }));
