...
function useNormalizedInputProps(_ref) {
  ...
  if (readOnly) {
    normalizedProps.icon = _iconsReact.EditOff16;
  } else {
    if (normalizedProps.invalid) {
      normalizedProps.icon = _iconsReact.WarningFilled16;
      normalizedProps.validation = /*#__PURE__*/_react.default.createElement("div", {
        className: "".concat(prefix, "--form-requirement"),
        id: normalizedProps.invalidId
      }, invalidText);
    } else if (normalizedProps.warn) {
      normalizedProps.icon = _iconsReact.WarningAltFilled16;
      normalizedProps.validation = /*#__PURE__*/_react.default.createElement("div", {
        className: "".concat(prefix, "--form-requirement"),
